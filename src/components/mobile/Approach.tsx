...
export default function MobileApproach() {
  ...
  useEffect(() => {
    const measure = () => {
      ...
      // How far the text extends beyond the right edge of the screen
      const overflow = Math.max(0, text.scrollWidth - window.innerWidth + 30);
  ...
  return (
    <section className="flex flex-col w-full">
      ...
      ── */}
      <div className="bg-[#151324] px-[30px] pt-[258px] pb-20">
        <div className="flex flex-col justify-start items-start gap-40">

          <div className="self-stretch flex flex-col justify-start items-start gap-40">
            <div className="w-72 justify-start text-stone-50 text-4xl font-light font-['Fustat'] leading-10">
            ...
            <div className="self-stretch flex flex-col justify-start items-center">
              <div className="w-full text-center justify-start text-stone-50 text-4xl font-light font-['Fustat'] leading-10">
                We build what your reality demands
              </div>
              <div className="w-full opacity-20 text-center justify-start text-stone-50 text-4xl font-light font-['Fustat'] leading-10">
                — and see it through.
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col justify-start items-start gap-2 w-full">
            <div className="w-full h-6 text-center justify-start text-zinc-300 text-xl font-light font-['Fustat']">
              How this actually works:
            </div>
          </div>

          <div className="self-stretch flex flex-col justify-start items-start gap-40 w-full">
            ...
            <div className="w-full flex flex-col justify-start items-start">
              <div className="self-stretch flex justify-between items-start">
                ...
                <div className="w-6 h-6 border-[0.5px] border-indigo-200 rotate-45 mt-2" />
              </div>
            </div>
            <div className="self-stretch flex flex-col justify-start items-start">
              <div className="w-full justify-start">
