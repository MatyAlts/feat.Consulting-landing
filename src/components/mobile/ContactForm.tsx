...
export default function ContactForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!scriptUrl) {
        console.warn('VITE_GOOGLE_SCRIPT_URL not set. Form submission simulated.')
  ...
  return (
    ...
    >
      ...
      <div className="px-5.75 pt-7.75">
        ...
        >
          One focused session to identify<br />
          where scale is stalling, and how to<br />
          correct it.
        </p>
      ...
      >
        <div className="absolute inset-0 bg-black/20 backdrop-blur-sm" onClick={() => setShowFrictionMenu(false)} />
        ...
        >
          <div className="p-6 pb-2 border-b border-zinc-100 flex items-center justify-between">
            ...
            <button type="button" onClick={() => setShowFrictionMenu(false)} className="text-zinc-400">
              ...
              {frictionOptions.map((option, idx) => {
                ...
                return (
                  <div key={idx}>
                    ...
                    >
                      <span className={`flex-1 font-['Lato'] font-light text-[18px] leading-snug mr-4 transition-colors duration-200 ${isSelected ? 'text-brand-hero-body font-normal' : 'text-[#171425]'}`}>
                        {option}
                      </span>
                      <div 
                      ...
                      >
                        {isSelected && (
                          <svg width="12" height="9" viewBox="0 0 12 9" fill="none" className="animate-zoom-in">
